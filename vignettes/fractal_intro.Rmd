...
surf <- sim_dem(n=128, smoothness=0.5, z_extent = TRUE)
raster::plot(surf)

# fractal dimension using height variation method
d1 <- fd(surf, method="cubes", lvec=c(4, 8, 16, 32, 64, 128), diagnose=TRUE, )
d2 <- fd(surf, method="cubes", lvec=c(4, 8, 16, 32, 64, 128), diagnose=TRUE, )
...
```{r}
# simulate fractal terrain
surf <- sim_dem(n=256, smoothness=0.5)
plot(surf)
