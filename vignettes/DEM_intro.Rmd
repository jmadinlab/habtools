...
```{r}
# Area method
fd(dem1, lvec = c(0.03125, 0.0625, 0.125, 0.25), plot = T, method = "area")
```


## Multiple metrics
Note that the resolution (L0) for the rugosity calculation will be set as the smallest value of `lvec` in the `rdh()` function if method_fd is "hvar", "cubes", or "sd".
```{r}
